...
import com.internshala.bookhub.util.ConnenctionManager
...
class DescriptionActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if (ConnenctionManager().checkConnectivity(this@DescriptionActivity)) {
            val jsonRequest =
                object : JsonObjectRequest(Request.Method.POST, url, jsonParams, Response.Listener {
                    try {
                        ...
                        if (success) {
                            ...
                            Picasso.get().load(bookJsonObject.getString("image")).error(R.drawable.reader).into(imgBookImage)
